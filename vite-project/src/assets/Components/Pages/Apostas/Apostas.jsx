        ...
        <>
            ...
            <div className="bg-[linear-gradient(to_top,#143896,#000000_100%)] text-white px-4 md:px-16">
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <button className="bg-[#486ac0] rounded-lg text-white p-4 text-base border-none cursor-pointer">
                        Escolha uma opção de aposta
                    </button>
                </div>
                <BetList2 />
                ...
                <div className="flex items-center justify-center pb-10 mt-8">
                    <button className="bg-[#486ac0] rounded-lg text-white p-4 text-lg border-none cursor-pointer w-[250px]">
                        Ver mais corridas
                    </button>
                </div>
            </div>
